...
public interface PessoaService {
    ...
    Pessoa salvar(String nome, String cpfCnpj, String telefone, String email, TipoPessoa tipoPessoa) throws BadRequestException, ConflictException, InternalServerErrorException;
